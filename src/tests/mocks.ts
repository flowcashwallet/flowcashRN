...
export const mockForecastFactory = (overrides = {}) => ({
  ...
  daily_burn_rate_7d: 55.0,
  daily_burn_rate_30d: 48.0,
  daily_burn_rate_60d: 50.0,
  spending_trend: "stable",
  confidence: "high",
  confidence_history_days: 90,
  confidence_expense_days: 45,
  daily_allowance: 100.0,
  projected_balance: 1000.0,
  remaining_budget: 1000.0,
  remaining_excluding_today: 980.0,
  spending_change_vs_last_month: 0.05,
  tip: "Save more!",
  ...overrides,
});
